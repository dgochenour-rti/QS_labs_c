...
int publisher_main(int domainId, int sample_count)
{
    ...
    /* LAB 6 -- specify the QoS library/profile for the Publisher */
    ...
    /* LAB 6 -- specify the QoS library/profile for the DataWriter */
    ...
    */
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
         ...
         * they aren't empty
         */
        /* LAB #10 -- change name dynamically so that we can filter on it */
        if (count % 2 == 0) {
            instance->name = "Don Gochenour";
        } else {
            instance->name = "Kelly Sanders";
        }
        instance->id = 9017;
        ...
        /* LAB #8 -- wait for acknowledgements */
        DDS_DataWriter_wait_for_acknowledgments(qs_qs_type_writer, 
